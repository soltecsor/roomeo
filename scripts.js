 ...
 $('.type-select-form').click(function(e) {
  ...
  $(window).scroll(function() {
    if ($(this).scrollTop() > 60) {
      ...
      $('header .brand-link').find('img').attr('src','/portal/assets/images/logoH.png').fadeIn(200);
    } else {
      $('header').removeClass('fixo');
      $('header .brand-link').find('img').attr('src','/portal/assets/images/logo.png').fadeIn(200);
    }
  });
