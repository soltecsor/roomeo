...
export default {
    ...
    getters: {
        images(state) {
            state.images = state.units.filter(v => v.image_urls)
            return state.images
        }
    },
    mutations: {
        ...
        [GET_ID_UNIT](state, payload){
            state.id_unit = payload
        }
    }
}